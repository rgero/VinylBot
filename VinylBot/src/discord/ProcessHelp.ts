      ...
      .addFields(
        ...
        { 
          ...
          value: 
            ...
            "`!have {spotify link}`: Adds an album to the have list.\n" +
            ...
            "`!havelist`: Gives you the whole have list.\n" +
            "`!havelist {person}`: Gives you the have list of that person.\n" +
            "`!havelist {search term}`: Gives you the have list items that match that term."
        },
        { 
